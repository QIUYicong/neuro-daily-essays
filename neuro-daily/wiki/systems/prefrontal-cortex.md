...
source_articles: [2026-06-05-prefrontal-working-memory, 2026-07-01-dorsal-attention-network-FEF-IPS, 2026-08-19-response-inhibition-hyperdirect-pathway, 2026-08-21-orbitofrontal-cortex-value-decision-circuit, 2026-08-24-dlpfc-cognitive-flexibility-rule-switching, 2026-08-25-vmPFC-sgACC-emotion-regulation, 2026-07-16-hippocampal-theta-sweeps-goal-direction]
key_sources: ["PMID:7695894", "PMID:21345366", "PMID:41478518", "PMID:39381500", "PMID:13679398", "PMID:11994752", "PMID:32155442", "PMID:16510720", "PMID:28103476", "PMID:19407204", "PMID:29144973", "PMID:11283309", "PMID:11209083", "PMID:23685452", "PMC4412347", "PMID:24201281", "PMC4121670", "PMID:23177967", "PMC3907768", "PMID:19672274", "PMID:38010299", "PMID:42386948"]
---
...
| 清醒导航时 PFC-海马θ序列协同随目标导向扫描增强，随学习发展 | 大鼠 CA1+PFC 同步记录，跨训练阶段对比 | Tang et al. 2026 (PMID:42386948，bioRxiv全文) | 中-高（单一实验室子样本，行为学核心结论有独立交叉验证） |
...
- [[goal-directed-theta-sweeps]] — 清醒导航时 PFC 群体θ序列与海马目标导向扫描协同增强，随学习建立，是空间规划的在线跨脑区协同证据
- [[place-cells]] — 海马场所细胞群体θ扫描是与 PFC 协同的信号来源
...
### 与海马的清醒在线θ协同（2026-07-16 新增）

此前本页记录的海马-PFC 协同主要发生在睡眠巩固阶段（见 [[sharp-wave-ripples]] 页"前额叶主动抑制门控"）。Tang 等（2026, *Nat Neurosci*, PMID:42386948）的新证据表明，这种协同同样发生在清醒导航的在线规划阶段：PFC 自身群体活动在θ周期内也会产生压缩的空间序列，且当海马产生"目标导向θ扫描"（见 [[goal-directed-theta-sweeps]]）而非普通的侧向交替扫描时，PFC 序列与海马序列的一致性显著更高（*p* = 2.38×10⁻⁷），且这种协同随训练进程从无到有逐渐建立（早期训练无显著协同 *p* = 0.30，晚期训练显著协同 *p* = 1.05×10⁻⁵）。这为"PFC 参与空间规划"提供了一个新的、逐θ周期分辨率的直接证据来源，与该页已有的睡眠期 PFC 主动门控证据共同构成一幅"在线协同规划-离线巩固选择"的两阶段图景。
...
- 2026-07-16 · 修订（rev8）· 基于《脚还没动，海马已经指向了目标》一文（#199）· 新增"与海马的清醒在线θ协同"小节（Tang et al. 2026：PFC-海马θ序列协同随目标导向扫描增强、随学习发展）；证据表新增1行；related 新增 goal-directed-theta-sweeps、place-cells；key_sources 新增 PMID:42386948；与既有睡眠期 PFC 主动门控证据（见 sharp-wave-ripples.md）共同构成"在线协同-离线巩固"两阶段图景
