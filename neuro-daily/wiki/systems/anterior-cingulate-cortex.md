...
> **一句话定义**：位于额叶内侧面扣带沟前部的皮层区域，是疼痛情感成分的核心编码区、冲突监测与认知控制的关键节点，同时通过 ACC→PAG 通路提供强大的下行镇痛控制——因扣带回切除术后"知痛不感苦"的临床分离现象而在疼痛神经科学中具有里程碑地位。

## 当前理解

前扣带回（ACC）在大脑中处于独特的交汇位置：它连接边缘系统（情感）与前额叶（认知），也是"注意到痛"与"感到痛苦"之间的神经基底。

### 解剖分区

| 亚区 | 位置 | 主要功能 |
|------|------|---------|
| **背侧 ACC（dACC）** | 背侧扣带回（BA24/32） | 认知冲突监测、错误检测、执行控制 |
| **亚属 ACC（sgACC）** | 膝下扣带回（BA25） | 情绪调节、抑郁相关；DBS 靶点 |
| **吻侧 ACC（rACC）** | 最前部扣带回 | 安慰剂镇痛、情感疼痛调控 |

在痛觉神经科学中，最关键的是 **dACC/rACC** 的功能。
