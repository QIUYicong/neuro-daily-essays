...
>
> 最后更新：2026-07-18（第201篇·甜到瘫软：催产素如何在杏仁核里把奖赏信号翻译成猝倒的开关）· 主题页总数：**352**（无新建页面；修订4页：diseases/narcolepsy rev1→rev2、concepts/orexin-hypocretin rev2→rev3、systems/amygdala rev8→rev9、concepts/oxytocin rev3→rev4；图谱356节点/2159边（本次同时订正_graph.json中1处历史节点重复：narcolepsy节点曾被重复记录两次，已合并为一条）；突破追踪：2026-07-14《Nature Neuroscience》新研究（Mahoney et al.，摘要级，全文未读）首次确立中央杏仁核催产素受体阳性神经元是猝倒被正性情绪/奖赏触发的分子-细胞开关，将Burgess et al. 2013年确立的解剖学电路框架（CeA GABA能神经元→vlPAG/LPT/LC/DR）精确到具体分子信使；矛盾登记：0个（新证据是既有电路框架的精确化而非冲突，未触发矛盾协议）；新增未解问题Q-narc-05（催产素通路与5-HT/多巴胺等其他候选通路的相对权重）；详见 wiki/CHANGELOG.md 2026-07-18 条目）
>
...
- 🟢 [突触剪枝](concepts/synaptic-pruning.md) — 先多建再精删策略；C1q/C3b"吃我"+CD47"别吃我"双向博弈；活动依赖（TTX实验）；dLGN/海马/前额叶分窗口；精神分裂症（C4A过度剪枝）与AD（C1q重激活）疾病连接；2026年新证据提示成年海马**过度活跃**（而非仅沉默）也可触发剪枝，emerging待验证 **[NEW 2026-06-03 · 修订 rev2 2026-07-15]**
- 🟢 [补体级联（CNS突触功能）](concepts/complement-cascade-cns.md) — C1q→C4→C3b经典通路；TGF-β（星形胶质细胞）诱导神经元C1q；CR3识别C3b触发吞噬；发育期/病理期的表达差异；2026年新证据提出抗体/IgM可能是C1q识别活动信息的"翻译者"（emerging，未经独立重复，已受同行质疑） **[NEW 2026-06-03 · 修订 rev2 2026-07-15]**
...
- 🟢 [食欲素（下丘脑泌素）与发作性睡病](concepts/orexin-hypocretin.md) — 外侧下丘脑8万神经元的"AAS总指挥"；缺失导致NT1（95%神经元丢失，HLA-DQB1*06:02）；OX2R激动剂danavorexton MWT改善11.1分（2024）；干细胞/基因治疗前景；**rev3新增**：猝倒电路精确化为CeA GABA能神经元→vlPAG/LPT/LC/DR（Burgess 2013）+ 催产素受体阳性神经元分子信使（Mahoney 2026，摘要级） **[NEW 2026-08-10 · 修订 rev2→rev3 2026-07-18]**
...
- 🟢 [催产素](concepts/oxytocin.md) — 下丘脑PVN/SON合成的九肽神经肽；OTR/Gq/11 GPCR；六条专化投射：①PVH→SuM→CA2（社会识别记忆）、②PVN→NAc（社会奖赏/配对联结）、③PVN→CeA（恐惧抑制/情绪辨别）、④SON→LS（哺乳期社会恐惧）、⑤aPVN→BNST（应激社交调制）、⑥CeA催产素受体阳性神经元（食欲素缺失背景下触发猝倒，**rev4新增**）；"社会凸显假说"解释双面性；非"爱的激素"而是多路社会调制器 **[NEW 2026-08-16 · 修订 rev3→rev4 2026-07-18]**
...
- 🟢 [杏仁核](systems/amygdala.md) — 外侧核（LA）通过LTP写入恐惧记忆；ITC细胞是恐惧/消退的分子闸门；基底核（BA）中恐惧神经元与消退神经元双群竞争；中央核（CeA）驱动防御行为输出；与PFC（IL/PL）和海马形成情绪调控三角回路；GC+NE协同增强BLA恐惧记忆巩固（β-AR必要门控）；CRH在CeA独立于HPA轴的中枢效应；BLA-LA 再巩固去稳定化分子链；皮质内侧核Proust效应解剖基础；vmPFC→杏仁核负向有效连接（认知重评+恐惧消退双机制）；**rev9新增**：CeA GABA能/催产素受体阳性神经元直接投射脑干vlPAG/LPT/LC/DR，是发作性睡病"猝倒"情绪触发的电路节点——杏仁核首次被记录连接至运动张力控制系统 **[修订 rev8→rev9 2026-07-18]**
...
- 🟢 [发作性睡病 1 型（NT1）](diseases/narcolepsy.md) — 外侧下丘脑食欲素神经元 T 细胞介导自身免疫选择性毁损（85–95%）→ 翻转开关失去稳定器 → 清醒-睡眠-REM 边界溶解；HLA-DQB1*06:02 携带者风险升高 251 倍（82–99% 患者阳性）；Latorre 2018 Nature 19/19 CD4+ T 细胞直接证据；Ollila 2023 GWAS 13 新位点（PRF1/CD207/IFNAR1/TCR）；CSF Hcrt-1 ≤110 pg/mL 诊断标准；OX2R 激动剂 Phase II/III；**rev2新增**：猝倒电路精确化为CeA GABA能神经元→vlPAG/LPT/LC/DR（Burgess 2013因果证据）+ CeA催产素受体阳性神经元分子信使（Mahoney 2026，摘要级） **[NEW 2026-10-15 · 修订 rev1→rev2 2026-07-18]**
