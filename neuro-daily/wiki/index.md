...
>
> 最后更新：2026-07-25（第93篇·桶状皮层×NMDA受体依赖竞争×STDP发育切换×触须拓扑地图）· 主题页总数：**160**（新建1页：systems/barrel-cortex；修订4页：concepts/stdp rev1→rev2、concepts/critical-period rev2→rev3、circuits/thalamocortical-circuit rev3→rev4、systems/barrel-cortex rev1；图谱164节点、1017边；新增Q-barrel-human-analog、Q-barrel-adult-plasticity-limit、Q-barrel-septum-function、Q-stdp-all-ltp-molecular-switch）
...
- 🟢 [桶状皮层](systems/barrel-cortex.md) — 啮齿类wS1第四层每根触须对应一个barrel；NMDA受体依赖竞争（P0–P5）形成结构；PV成熟驱动L4→L2/3 STDP全LTP→赫布型切换（P12–P23）开启功能关键期；经典发育感觉地图研究模型系统 **[NEW 2026-07-25]**
...
| 3. 大脑如何编码世界 | 🔵 进行中（已覆盖：**场所细胞（2026-06-22 wiki建立）**, **网格细胞（2026-06-22 wiki建立）**, θ振荡/相位编码, **V1方向选择性（2026-06-11）**, **路径整合（2026-06-22）**, **运动编码-旋转动力学（2026-06-21）**, **小脑前向模型（2026-06-23）**, **桶状皮层/体感触须地图（2026-07-25）**；待覆盖：听觉皮层, 头向细胞, 时间表征）|
