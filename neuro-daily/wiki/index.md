...
>
> 最后更新：2026-06-29（第65篇·视觉皮层关键期·GABA阈值、PNNs制动器与成年可塑性重启）· 主题页总数：**113**（新建2页：critical-period, perineuronal-nets；修订2页：v1-primary-visual-cortex rev4, bdnf rev2）
...
- 🟢 [脑源性神经营养因子（BDNF）](concepts/bdnf.md) — 神经活动诱导释放的关键成长信号；TrkB三通路（PLCγ/ERK/Akt）；proBDNF→p75NTR与成熟BDNF→TrkB的双向开关；L-LTP的催化分子；SGZ神经发生的存活驱动力；AD早期受损靶点；Val66Met多态性；BDNF过表达绕过视觉经验提前开启关键期（Gianfranceschi 2003）**[修订 2026-06-29]**
- 🟢 [关键期（视觉皮层）](concepts/critical-period.md) — GABA_A α1电路（PV+细胞）的成熟阈值触发可塑性窗口开启；单眼剥夺引发双相OD偏移；PNNs/Lynx1/PSD-95等分子制动器积极维持关键期关闭；成年后可通过软骨素酶、暗养、HDAC抑制剂等重启可塑性（Pizzorusso 2002 Science因果实验）；多时间尺度调控框架（毫秒γ→天月CLOCK/BMAL→年代际表观遗传）**[NEW 2026-06-29]**
- 🟢 [围神经元网（PNNs）](concepts/perineuronal-nets.md) — CSPG为主的网状细胞外基质；PV+细胞体周；形成与关键期关闭时间吻合；软骨素酶-ABC降解后恢复成年可塑性（Pizzorusso 2002）；可能通过物理屏障+PTPσ受体+Otx2固定维持稳定态 **[NEW 2026-06-29]**
