...
- 🔵 [FOXP2转录因子](concepts/foxp2.md) — 叉头域转录因子；KE家族R553H突变→发育性言语失用；两个人类特异性氨基酸替换（60倍进化加速）；皮层-纹状体回路分子调控（D1/D2+LTD）；人化小鼠加速陈述→程序性学习；鸣禽Area X流畅性调控；FOXP2-CNTNAP2通路；深度同源性 **[NEW 2026-08-24 #122]**
- 🔵 [声音习得型发声的趋同进化](concepts/vocal-learning-evolution.md) — 鸣禽/鹦鹉/蜂鸟/鲸目/蝙蝠/人类独立进化；均依赖皮层-基底节回路；FoxP2深度同源性；声音学习的核心计算需求 **[NEW 2026-08-24 #122]**
